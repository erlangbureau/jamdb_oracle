defmodule Jamdb.Oracle.SQL do
  ...
  defp column_definition(table, {:add, name, %Reference{} = ref, opts}) do
    [column_source(name, opts), ?\s, column_type(ref.type, Keyword.put(opts, :reference, true)),
  ...
  defp column_change(table, {:add, name, %Reference{} = ref, opts}) do
    ["ADD ", column_source(name, opts), ?\s, column_type(ref.type, Keyword.put(opts, :reference, true)),
  ...
  defp column_type(type, opts) when type in [:serial, :bigserial] do
    cond do
      Keyword.get(opts, :reference, false) -> "int"
      Keyword.get(opts, :primary_key, false) -> ecto_to_db(:serial)
      true -> "int"
    end
  end
  ...
  defp ecto_to_db(:serial),              do: "integer generated by default as identity"
